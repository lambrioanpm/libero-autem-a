[![](https://img.shields.io/npm/v/@lambrioanpm/libero-autem-a.svg?style=flat)](https://www.npmjs.com/package/@lambrioanpm/libero-autem-a)
[![](https://img.shields.io/npm/dt/@lambrioanpm/libero-autem-a.svg)](https://www.npmjs.com/package/@lambrioanpm/libero-autem-a)
...
Generate a new React Native(**v0.73**) app using the **@lambrioanpm/libero-autem-a**:

```shell
npx react-native init myapp --template @lambrioanpm/libero-autem-a --skip-install
```
